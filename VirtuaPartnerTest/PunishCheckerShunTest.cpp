...
namespace PunishCheckerShunTest
{
	...
	public:
		...
		TEST_METHOD(TestPlayer1Shun15FramePunishDucking)
		{
			...
			filename = _T("data\\shun_blocked_mule_kick_19exe.gif");
			result = testShunPunishWithWindow();
			Assert::AreEqual(false, result, _T("Blocked mule kick counted as max punish for 15 frame counterable move"));
		...
		TEST_METHOD(TestPlayer1Shun18FramePunish)
		{
			...
			filename = _T("data\\shun_18_frame_suiryu_counter_10_drinks.gif");
			result = testShunPunishWithWindow();
			Assert::AreEqual(true, result, _T("18 frame punish did not count as max for 18 frames"));

			filename = _T("data\\shun_16_frame_46pk_punish_standing.gif");
			result = testShunPunishWithWindow();
			Assert::AreEqual(false, result, _T("16 frame punish counted as max"));

			filename = _T("data\\shun_16_frame_chowan_counter_6_drinks.gif");
			result = testShunPunishWithWindow();
			Assert::AreEqual(false, result, _T("16 frame punish did not count as max for 16 frames"));
		...
		TEST_METHOD(TestPlayer1Shun17FramePunish)
		{
			frameAdvantage = 17;
			recoversLow = false;
			...
			filename = _T("data\\shun_16_frame_chowan_counter_6_drinks.gif");
			result = testShunPunishWithWindow();
			Assert::AreEqual(false, result, _T("16 frame chowan punish counted as max for 17 frames"));

			filename = _T("data\\shun_16_frame_46pk_punish_standing.gif");
			result = testShunPunishWithWindow();
			Assert::AreEqual(false, result, _T("16 frame eye poke punish counted as max"));
		...
		TEST_METHOD(TestPlayer1Shun16FramePunish)
		{
			frameAdvantage = 16;
			recoversLow = false;
			...
			filename = _T("data\\shun_16_frame_46pk_punish_standing.gif");
			result = testShunPunishWithWindow();
			Assert::AreEqual(true, result, _T("16 frame punish did not count as max for 16 frames"));
